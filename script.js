...
brushColorBtn.addEventListener("change", () => {
  isEraser = false; //the eraser acts as a brush but with the same backgrounds color
...
eraser.addEventListener("click", () => {
  ...
  currentSize = 50; // eraser by defult size 50px
});
...
function switchToBrush() {
  ...
  currentColor = `#${brushColorBtn.value}`;
  currentSize = 10;
  brushSlider.value = 10; // reset the size each time that brush is selected again
  displayBrushSize();
}
